...
return array(
	...
	'properties' => array(
		'creator' => 'ClaremontDesign Zbase',
		'lastModifiedBy' => 'ClaremontDesign Zbase',
		'title' => 'Spreadsheet',
		'description' => 'Default spreadsheet export',
		'subject' => 'Spreadsheet ClaremontDesign Zbase export',
		'keywords' => 'ClaremontDesign Zbase, excel, export',
		'category' => 'Excel',
		'manager' => 'ClaremontDesign Zbase',
		'company' => 'ClaremontDesign Zbase',
	),
	/*
	  |--------------------------------------------------------------------------
	  | Sheets settings
	...
	'export' => array(
		...
		'store' => array(
			/*
			  ...
			  |
			 */
			'path' => zbase_public_download_folder(),
			/*
			  |--------------------------------------------------------------------------
			  | Return info
			  |--------------------------------------------------------------------------
