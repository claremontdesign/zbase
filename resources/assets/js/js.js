...
/**
 * Unset value from a given array; Not assoc
 * @param {type} array
 * @param {type} string
 * @returns {undefined}
 */
function unsetFromArray(array, string)
{
...
function zbase_ajax(dataConfig)
{
	...
	var formData = dataConfig.formData !== undefined ? dataConfig.formData : {};
	...
	{
		var data = jQuery.extend(formData, {json: 1});
...
var Zbase = function () {
	...
	var initDatatable = function () {
		...
		{
			jQuery('.zbase-datatable-row-toggle').find('.row-details-toggler').unbind('click').click(function () {
				var r = jQuery(this).parent('tr');
